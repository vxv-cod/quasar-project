...
<script setup>
  ...
  const zeroRows = computed(() => store.state.projects.copiedProjects)
  const loadData = computed(() => store.getters.getProjects)
  // const loadData = computed(() => structuredClone(zeroRows.value))
